!(function (n) {
                                    ...
                                    switch ((n.prev = n.next)) {
                                        ...
                                        case 16:
                                            for (
                                                ...
                                                (o = document.createElement("div")), (o.className = "bullet".concat(0 === i ? " active" : "")), o.setAttribute("data-idx", i), g.appendChild(o);
    ...
    function (n, e, t) {
        ...
        function u(n, e) {
            ...
            if (e.singleton) {
                ...
                n.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa
                    ? ((t = c(e)),
                      (i = m.bind(null, t, e)),
                      (o = function () {
    ...
    function (n, e, t) {
        ...
        function i() {
            ...
            (d.style.marginLeft = "".concat(-0.5 * i.width, "px")), (d.style.marginTop = "".concat(-0.5 * i.height, "px"));
        }
        function o() {
        ...
        function a(n) {
            ...
            PokiSDK.gameLoadingProgress(t),
                n >= 1 &&
                    "done" !== f.className &&
                    ((f.className = "done"), (document.getElementById("progress-comment").innerHTML = "Preparing game..."), (document.getElementById("progress-spinner").style.display = "flex"), g && clearTimeout(g));
        }
        function s() {
        ...
        function c() {
            ...
            (n.src = "".concat("Build", "/").concat(w.a.metadata.loader_filename)),
                ...
                w.a.fileSize && ((m.innerHTML += " of ".concat(w.a.fileSize, "MB")), (m.style.width = "12vh"), (m.style.whiteSpace = "nowrap")),
                s();
        }
        function l() {
    ...
    function (n, e, t) {
        var i = (function (n) {
            ...
            function l(n, e) {
                ...
                return r
                    ? r.done
                        ? ((e[n.resultName] = r.value), (e.next = n.nextLoc), "return" !== e.method && ((e.method = "next"), (e.arg = p)), (e.delegate = null), I)
                        : r
                    : ((e.method = "throw"), (e.arg = new TypeError("iterator result is not an object")), (e.delegate = null), I);
            }
            function d(n) {
                var e = { tryLoc: n[0] };
            ...
            function f(n) {
                (this.tryEntries = [{ tryLoc: "root" }]), n.forEach(d, this), this.reset(!0);
            }
            function h(n) {
                if (n) {
                    var e = n[y];
            ...
            return (
                ...
                (f.prototype = {
                    ...
                    delegateYield: function (n, e, t) {
                        return (this.delegate = { iterator: h(n), resultName: e, nextLoc: t }), "next" === this.method && (this.arg = p), I;
                    },
                }),
                n
            );
